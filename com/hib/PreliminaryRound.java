...
public class PreliminaryRound extends Round {

	public PreliminaryRound() {
		super();
	}
	
	public PreliminaryRound(String name, GregorianCalendar startdate, GregorianCalendar enddate, String mode) {
